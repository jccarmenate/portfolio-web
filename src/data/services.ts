...
export const services: Service[] = [
  {
    ...
    description: {
      es: 'Fine-tuning de modelos de lenguaje, pipelines RAG con recuperación híbrida y sistemas de agentes orquestados con LangGraph para automatizar flujos de trabajo reales.',
      en: 'LLM fine-tuning, RAG pipelines with hybrid retrieval, and LangGraph-orchestrated agent systems that automate real workflows.',
    },
  ...
  },
  {
    ...
    description: {
      es: 'Programación de bajo nivel con sockets (incluidos raw sockets AF_PACKET), herramientas de seguridad de red y servicios de servidor en C y Python.',
      en: 'Low-level socket programming (including raw AF_PACKET sockets), network security tooling, and server-side services in C and Python.',
    },
